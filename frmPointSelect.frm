...
Begin VB.Form frmPointSelect 
   ...
   ClientTop       =   0
   ClientWidth     =   4590
   Icon            =   "frmPointSelect.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmPointSelect.frx":08CA
   ScaleHeight     =   161
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   306
   ...
   Begin VB.PictureBox BOk 
      ...
      Height          =   345
      Left            =   840
      Picture         =   "frmPointSelect.frx":24BA4
      ScaleHeight     =   23
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   95
      TabIndex        =   7
   ...
   Begin VB.PictureBox BCancel 
      ...
      Height          =   345
      Left            =   2400
      Picture         =   "frmPointSelect.frx":25542
      ScaleHeight     =   23
      ScaleMode       =   3  'Pixel
      ScaleWidth      =   95
      TabIndex        =   5
   ...
   Begin VB.Image BU 
      Height          =   345
      Left            =   4440
      Picture         =   "frmPointSelect.frx":25EE0
      Top             =   360
      Visible         =   0   'False
      Width           =   1425
   End
   Begin VB.Image BD 
      Height          =   345
      Left            =   4440
      Picture         =   "frmPointSelect.frx":2687E
      Top             =   0
      Visible         =   0   'False
      Width           =   1425
   End
   ...
   End
End
Attribute VB_Name = "frmPointSelect"
...
If frmMain.IsNumber(XBox.Text) = True And frmMain.IsNumber(YBox.Text) = True Then
frmMain.CControl.TextMatrix(frmMain.CControl.Row, frmMain.CControl.Col) = XBox.Text & "," & YBox.Text
Unload Me
Else
